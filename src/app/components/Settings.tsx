        ...
        {activeTab === "company" && (
          <div className="max-w-xl space-y-6">
            ...
            <div className="rounded-xl px-4 py-3 text-xs" style={{ background: "var(--muted)", color: "var(--muted-foreground)" }}>
              Esses dados ainda não estão salvos em lugar nenhum — quando você preencher e clicar em salvar, vamos criar o armazenamento real.
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="sm:col-span-2">
                <FormField label="Nome da empresa" placeholder="Ex: DeCaires Technology" />
              </div>
              <FormField label="CNPJ" placeholder="00.000.000/0001-00" />
              <FormField label="Setor" placeholder="Ex: Tecnologia da Informação" />
              <FormField label="Email corporativo" type="email" placeholder="contato@suaempresa.com.br" />
              <FormField label="Site" placeholder="suaempresa.com.br" />
              <div className="sm:col-span-2">
                <FormField label="Endereço" placeholder="Cidade, Estado – País" />
              </div>
            </div>
          </div>
        )}
